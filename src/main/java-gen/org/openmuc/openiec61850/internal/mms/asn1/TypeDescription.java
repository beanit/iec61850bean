...
public class TypeDescription implements Serializable {
    ...
    public static class Array implements Serializable {
        ...
        public int encode(OutputStream os, boolean withTag) throws IOException {
            ...
            sublength = elementType.encode(os);
            ...
            if (packed != null) {
                codeLength += packed.encode(os, false);
    ...
    public static class Structure implements Serializable {
        ...
        public static class Components implements Serializable {
            ...
            public static class SEQUENCE implements Serializable {
                ...
                public int encode(OutputStream os, boolean withTag) throws IOException {
                    ...
                    sublength = componentType.encode(os);
                    codeLength += sublength;
                    codeLength += BerLength.encodeLength(os, sublength);
                    ...
                    if (componentName != null) {
                        codeLength += componentName.encode(os, false);
                        // write tag: CONTEXT_CLASS, PRIMITIVE, 0
                        os.write(0x80);
                        codeLength += 1;
                    }
        ...
        public int encode(OutputStream os, boolean withTag) throws IOException {
            ...
            int codeLength = 0;
            codeLength += components.encode(os, false);
            // write tag: CONTEXT_CLASS, CONSTRUCTED, 1
            os.write(0xA1);
            codeLength += 1;
    ...
    public static class FloatingPoint implements Serializable {
        ...
        public int encode(OutputStream os, boolean withTag) throws IOException {
            ...
            int codeLength = 0;
            codeLength += exponentWidth.encode(os, true);

            codeLength += formatWidth.encode(os, true);
